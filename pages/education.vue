    ...
    <section class="timeline">
      <ol class="timeline-list">
        ...
        <li class="timeline-item">
          ...
          <span>From April 2019 — Until July 2023</span>
        ...
        <li class="timeline-item">
          ...
          <span>From Jan 2015 — Until Nov 2018</span>
          <p class="timeline-text-bold">
            High School
          </p>
          <p class="timeline-text">
            ...
            - 2 times Gold in the school's talent show in group vocals <br>
            - 2 times Gold in the school's talent show in group instrumentals
          </p>
        </li>
      </ol>
    </section>
